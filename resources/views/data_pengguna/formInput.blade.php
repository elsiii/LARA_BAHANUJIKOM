                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row row-xs align-items-center mg-b-20">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                            <select name="namerole" class="form-control select2" name="kategori_id">
                                    ...
                                    <div class="row row-xs align-items-center mg-b-20">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                            <div class="input-group">
                                                <input id="datepickerB" class="form-control" name="wkt_input" value="{{date('d/m/Y')}}" placeholder="DD/MM/YYYY" type="text">
